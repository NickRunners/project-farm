...
// it returns: 0 -> ok, 1 -> string is not a number, 2 -> overflow/underflow
...
// check if the name provided as first argument is a regular file
// it returns: 1 -> success, 0 -> not a regular number, -1 -> error
